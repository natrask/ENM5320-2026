...
% ============================================================
\begin{frame}[fragile]{Tool calling, concretely}
  We describe each tool to the model with a JSON schema:
...
\end{lstlisting}
  ...
  When the LLM wants to use it, we get back a structured
  \texttt{function\_call} with \texttt{name="calculator"} and
  \texttt{args=\{op:"mul", a:13, b:47\}}, instead of plain text.
\end{frame}
